    ...
    public class ProductCategoriesController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                HttpResponseMessage Res = await client.GetAsync("https://localhost:44390/api/ProductCategories/");
        ...
        public async Task<ActionResult> Create()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                client.DefaultRequestHeaders.Clear();
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                HttpResponseMessage Res = await client.GetAsync("https://localhost:44390/api/MasterProductCategories/");
                if (Res.IsSuccessStatusCode)
                {
                    //Storing the response details recieved from web api
                    var ProResponse = Res.Content.ReadAsStringAsync().Result;
        ...
        public async Task<ActionResult> Create(ProductCategoryBL ProCategory)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                //Sending request to find web api REST service resource GetAllEmployees using HttpClient
                HttpResponseMessage Res = await client.PostAsync("https://localhost:44390/api/ProductCategories/", content);
                //Checking the response is successful or not which is sent using HttpClient
                if (Res.IsSuccessStatusCode)
                {
                    //Storing the response details recieved from web api
        ...
        public async Task<ActionResult> Edit(int ProductCategoryId)
        {
            try
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    client.DefaultRequestHeaders.Clear();
                    client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                    HttpResponseMessage Res = await client.GetAsync("https://localhost:44390/api/ProductCategories/" + ProductCategoryId);
                    if (Res.IsSuccessStatusCode)
                    {
                        //Storing the response details recieved from web api
                        var ProResponse = Res.Content.ReadAsStringAsync().Result;
                    ...
                    HttpResponseMessage Res2 = await client.GetAsync("https://localhost:44390/api/MasterProductCategories/");
                    ...
                    using (var package = new ExcelPackage(file.InputStream))
                    {
                        ...
                        for (int rowIterator = 2; rowIterator <= noOfRow; rowIterator++)
                        {
                            if (workSheet.Cells[rowIterator, 1].Value != null)
                            {
                                ...
                                productCategoryBL.MasterProductCategoryId = Convert.ToInt32(workSheet.Cells[rowIterator, 3].Value);                                
